      ...
      <div className="max-w-3xl mx-auto px-6 pb-24">
        <div className="glass rounded-3xl p-8 md:p-10 legal-prose">
          ...
          <p>
            ...
            users to create and manage a digital wardrobe, receive AI-generated
            outfit suggestions based on their wardrobe and local weather
            conditions, and track outfit wear history.
          </p>
          <p>
