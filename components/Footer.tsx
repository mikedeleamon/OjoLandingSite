          ...
          <div>
            <div className="flex items-center gap-2.5 mb-3">
              <div className="w-7 h-7 rounded-xl glass-strong flex items-center justify-center">
                <span className="font-outfit font-bold text-white text-xs">O</span>
              </div>
              <span className="font-outfit font-semibold text-white text-base">{APP_NAME}</span>
            </div>
            <p className="text-white/60 text-sm leading-relaxed">
              Your weather-aware outfit companion. Dress smarter, every day.
            </p>
            <div className="mt-4 inline-flex items-center gap-2 glass rounded-full px-3 py-1.5">
              ...
              <span className="text-white/70 text-xs font-medium">Coming soon to App Store</span>
            </div>
          </div>
